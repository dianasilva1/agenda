...
export class ContatoComponent implements OnInit {
  ...
  colunas = ['foto', 'nome', 'telefone', 'email', 'favorito', 'excluir'];
  ...
  createForms() {
    this.formulario = this.fb.group({
      form_nome: ['', Validators.required],
      form_telefone: ['', Validators.required],  /* POR PADRÃO, UM VALOR VAZIO SERÁ PASSADO */
  ...
  submit() {
    ...
    const c: Contato = new Contato(formValues.form_nome, formValues.form_telefone, formValues.form_email);
